1. [https://www.cdc.gov/mobile/applications/sto/web-app.html](https://www.cdc.gov/mobile/applications/sto/web-app.html)

- What is the problem
	- Case definition to identify case
	- Who, what, where, when
- What is the cause
	- Why is the outbreak happening
	- Infectious agent
...
- Rash in Wisconsin
- People who do not seem to have anything to do with each other are coming down with it

- Clue 1
	- 7 year old girl has been in serious condition since May 16
		- High fever
		- Headache
		- Swollen glands
		- Rash
	- Rash is similar to chickenpox with large swollen spots over the body
	- Tests
		- MRSA, herpes, fungus
	- Smallpox
		- Contagious and sometimes fatal disease
		- Infected persons get high fevers and raised bumps on face and body
		- Smallpox has been around but vaccination has ended the disease (last occurring case in 1977)
- Cases
	- 4 new cases
		- High fever
		- Rash
		...
		- Nausea
		- Diarrhea
	- Has spread across state
	- Sick are not connected

- Clue 2
	- Negative for chickenpox and other expected illnesses
	- Total 11 people sick
		- 2 people have returned from Costa Rica
		- Rainforests
...
- Clue 3
	...
	- Breathing on a tube from inflamed throat
	- 6 people in hospital, 4 critical
	- 3 new cases
	- Disease starts mild fever, headache, muscle aches, and exhaustion
	- Rash appears after 1-3 days
	- One new patient works at a local pet store
		- Zootonic
	- Many patients have animals
...
- Clue 4
	- Prairie dogs
		- Cindy's parents have bought the pet at a local flea market May 1
		- Scooter scratched Cindy on May 4
	- Everyone, except 2 of the patients, had purchased a pet prairie do in the last few weeks
	- 2 outlier patients have a grandson who has gotten one
	- mpox
		- Disease usually found in Africa
		- Spread by infected animals that bite or scratch others and can also be spread from person to person through long periods of face-to-face contact
		- Symptoms appear about 12 days after someone has been exposed
		- Initial symptoms
			- Headache, muscle aches, backaches
		- Few days after
